...
<div id="presentation">
	...
	<div class="col-sm-12" id="title">
		<h1 class="text-center font-weight-bold">BILLET SIMPLE POUR L'ALASKA</h1>
		<h2 class="text-center font-weight-bold">JEAN FORTEROCHE</h2>
		<div class="text-center bg-transparent">
			<a class="scrollTo" href="#home"><button type="button" class="fas fa-angle-double-down bg-transparent" id="button_home" ></button></a>
		</div>
	</div>	
</div>

<div class="col-md-12 p-5" id="home">
